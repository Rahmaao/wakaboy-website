        ...
        <div className="flex flex-col items-center md:items-center md:flex-row justify-evenly bg-[#FFEF54] w-full h-[480px] md:h-[80%]">
          ...
          <div className="w-[85%] md:w-[30%] xl:w-[25%] h-[200px] md:h-full flex items-center">
            <div className="w-full h-full md:h-[80%]">
              ...
              <WaitlistForm2 />
              <div className="w-[25%] md:w-[30%] lg:w-[30%] h-[20%] mt-4 flex justify-between items-center">
                {/* <a href="">
                  <Image
                    src="/fb.svg"
                    alt="Facebook"
                ...
                <a href="https://www.instagram.com/wakaboy.express?igsh=MmFmaml2a3diNWJt&utm_source=qr" target="_blank">
                  <Image
                    src="/ig.svg"
                    alt="Instagram"
                    width={32}
                ...
                <a href="https://www.linkedin.com/company/wakaboy-express/" target="_blank">
                  <Image
                    src="/in.svg"
                    alt="LinkedIn"
                    width={32}
